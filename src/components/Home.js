      ...
      <div className='max-w-screen-lg mx-auto flex flex-col md:flex-row h-full px-4 pt-24'>
        ...
        <div className='md:w-1/2 flex flex-col justify-center items-center md:pr-8'>
          ...
          <Link
            ...
            smooth
            duration={500}
            className='group text-white w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from-pink-600 to-purple-400 cursor-pointer'
          >
            About
        ...
        <div className='md:w-1/2 flex items-center justify-center mt-8 md:mt-0'>
          <img src={HeroImage} alt='my profile' className='rounded-full mx-auto w-full md:max-w-lg lg:max-w-xl' />
        </div>
      </div>
    </div>
  );
